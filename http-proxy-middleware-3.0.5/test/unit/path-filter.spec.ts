    ...
    describe('Single glob', () => {
      ...
      describe('file matching', () => {
        ...
        it('should only match .html under root path', () => {
          const pattern = '/*.html'
          expect(
            matchPathFilter(pattern, 'http://localhost/index.html', fakeReq),
          ).toBe(true)
          expect(
            matchPathFilter(
              pattern,
        ...
        it('should only match any file in root path', () => {
          expect(
            matchPathFilter('/*', 'http://localhost/bar.html', fakeReq),
          ).toBe(true)
          expect(
            matchPathFilter('/*.*', 'http://localhost/bar.html', fakeReq),
          ).toBe(true)
          expect(
            matchPathFilter('/*', 'http://localhost/foo/bar.html', fakeReq),
          ).toBe(false)
        })

        it('should only match .html file is in root path', () => {
          expect(
            matchPathFilter('/*.html', 'http://localhost/bar.html', fakeReq),
          ).toBe(true)
          expect(
            matchPathFilter(
              '/*.html',
    ...
    describe('Multi glob matching', () => {
      ...
      describe('Negation patterns', () => {
        it('should not match file extension', () => {
          ...
          expect(matchPathFilter(['**', '!**/*.html'], url, fakeReq)).toBe(
            false,
          )
